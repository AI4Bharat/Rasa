...
class FastPitchConfig(BaseTTSConfig):
    ...
    def __post_init__(self):
        ...
        # emotion embedding settings
        if self.use_emotion_embedding:
            self.model_args.use_emotion_embedding = True
        if self.emotions_file:
            self.model_args.emotions_file = self.emotions_file
