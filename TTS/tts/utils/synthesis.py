...
#     external_durations: np.ndarray = None,
...
#         external_durations (np.ndarray, optional): Force external durations to be used for synthesis. Defaults to None.
...
#         external_durations = numpy_to_torch(external_durations, torch.float32).to(inputs.device)
...
#     if external_speaker_embd is not None:
#         external_speaker_embd = id_to_torch(external_speaker_embd, cuda=use_cuda)
