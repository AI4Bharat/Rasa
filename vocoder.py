...
def get_arg_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_name', default='indictts', choices=['ljspeech', 'indictts', 'googletts', 'SAMHAAR', 'expressive_ta', 'expressive_as'])
    parser.add_argument('--language', default='ta', choices=['en', 'ta', 'te', 'kn', 'ml', 'hi', 'mr', 'bn', 'gu', 'or', 'as', 'raj', 'mni', 'pa', 'indianenglish', 'all', 'PS'])
